...
#define CHECKERROR                                        \
    std::cout << "\x1b[36m[DEBUG] Func: " << __FUNCTION__ \
              << " Line: " << __LINE__ << "\x1b[0m" << std::endl
#endif
...
private:
    ...
    void pickPhysicalDevice()
    {
        ...
        std::cout << "Selected Device: " << printDeviceProperties(m_PhysicalDevice)
                  << std::endl;
    }
    ...
    void createLogicalDevice()
    {
        ...
        vkGetDeviceQueue(
            m_Device, indicies.graphicsFamily.value(), 0, &m_GraphicsQueue);
        vkGetDeviceQueue(
            m_Device, indicies.presentFamily.value(), 0, &m_PresentQueue);
    }
    ...
    void recordCommandBuffer(VkCommandBuffer commandBuffer, uint32_t imageIndex)
    {
        ...
        vkCmdBindPipeline(
            commandBuffer, VK_PIPELINE_BIND_POINT_GRAPHICS, m_GraphicPipeline);
    ...
    void createDescriptorPool()
    {
        ...
        if (vkCreateDescriptorPool(m_Device, &poolInfo, nullptr, &m_DescriptorPool) != VK_SUCCESS)
            throw std::runtime_error("failed to create descriptory pool");
    }
